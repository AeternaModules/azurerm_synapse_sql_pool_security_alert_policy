output "synapse_sql_pool_security_alert_policies_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.id if v.id != null && length(v.id) > 0 }
}
output "synapse_sql_pool_security_alert_policies_disabled_alerts" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.disabled_alerts if v.disabled_alerts != null && length(v.disabled_alerts) > 0 }
}
output "synapse_sql_pool_security_alert_policies_email_account_admins_enabled" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.email_account_admins_enabled if v.email_account_admins_enabled != null }
}
output "synapse_sql_pool_security_alert_policies_email_addresses" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.email_addresses if v.email_addresses != null && length(v.email_addresses) > 0 }
}
output "synapse_sql_pool_security_alert_policies_policy_state" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.policy_state if v.policy_state != null && length(v.policy_state) > 0 }
}
output "synapse_sql_pool_security_alert_policies_retention_days" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.retention_days if v.retention_days != null }
}
output "synapse_sql_pool_security_alert_policies_sql_pool_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.sql_pool_id if v.sql_pool_id != null && length(v.sql_pool_id) > 0 }
}
output "synapse_sql_pool_security_alert_policies_storage_account_access_key" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.storage_account_access_key if v.storage_account_access_key != null && length(v.storage_account_access_key) > 0 }
  sensitive   = true
}
output "synapse_sql_pool_security_alert_policies_storage_endpoint" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.storage_endpoint if v.storage_endpoint != null && length(v.storage_endpoint) > 0 }
}
