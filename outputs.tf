...
output "synapse_sql_pool_security_alert_policies_email_account_admins_enabled" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.email_account_admins_enabled }
}
output "synapse_sql_pool_security_alert_policies_email_addresses" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.email_addresses }
}
output "synapse_sql_pool_security_alert_policies_policy_state" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.policy_state }
}
output "synapse_sql_pool_security_alert_policies_retention_days" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.retention_days }
}
output "synapse_sql_pool_security_alert_policies_sql_pool_id" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.sql_pool_id }
}
output "synapse_sql_pool_security_alert_policies_storage_account_access_key" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.storage_account_access_key }
  sensitive   = true
}
output "synapse_sql_pool_security_alert_policies_storage_endpoint" {
  ...
  value       = { for k, v in azurerm_synapse_sql_pool_security_alert_policy.synapse_sql_pool_security_alert_policies : k => v.storage_endpoint }
}
